...
// #define USE_GMP
#define USE_GMP_NUDUPL

#include <string>
#include <thread>

// Form using GMP library for big integer arithmetic
// squaring algorithms: modified NUDUPL, custom reducer
///////////////////////////////////////////////////////////////////////////////
#ifdef USE_GMP
...
// Form using GMP for big integers arithmetic
// squaring algorithm: Antic NUDUPL, custom reducer  
///////////////////////////////////////////////////////////////////////////////
#ifdef USE_GMP_NUDUPL
#include "VdfFormGmpNudupl.h"
using Form = VdfFormGmpNudupl;
#endif
